...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --enc-init /efs/exp/clai24/exp/atis.train_pytorch_fine-tune-train2/results/model.loss.best \
        --dec-init /efs/exp/clai24/exp/atis.train_pytorch_fine-tune-train2/results/model.loss.best \
