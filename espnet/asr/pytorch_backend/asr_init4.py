...
def load_trained_model(model_path, model_tag_and_class, tag_to_idx, class_to_idx, device):
    ...
    model = model_class(idim, odim, train_args, model_tag_and_class, tag_to_idx, class_to_idx, device)
...
def load_trained_modules(idim, odim, args, model_tag_and_class, tag_to_idx, class_to_idx, device, interface=ASRInterface):
    ...
    main_model = model_class(idim, odim, args, model_tag_and_class, tag_to_idx, class_to_idx, device)
