...
def get_parser():
    ...
    parser.add_argument("--beam-size2", type=int, default=1, help="Beam size")
    ...
    parser.add_argument(
        "--ctc-weight2", type=float, default=0.0, help="CTC weight in joint decoding"
    )
    parser.add_argument(
        "--weights-ctc-dec",
        type=float,
    ...
    parser.add_argument("--lm-weight2", type=float, default=0.1, help="RNNLM weight")
    # ngram related
    parser.add_argument(
    ...
    if args.num_spkrs == 1:
        if args.backend == "chainer":
            ...
            if args.num_encs == 1:
                ...
                if args.api == "v2":
                    from espnet.asr.pytorch_backend.recog2 import recog_v2
